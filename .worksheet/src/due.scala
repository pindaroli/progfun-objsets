import objsets._
object due {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(73); 
  ...
  sa union sc union sb;System.out.println("""res0: objsets.TweetSet = """ + $show(res$0));$skip(32); val res$1 = 
 	sc union sa union sb union sd;System.out.println("""res1: objsets.TweetSet = """ + $show(res$1));$skip(45); 
